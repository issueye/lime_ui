<template>
  <base-page title="版本管理" desc="版本管理">
    <template #content>
                ...
                <el-dropdown @command="handleCommand">
                  ...
                  <template #dropdown>
                    <el-dropdown-menu>
                      ...
                      >
                      <el-dropdown-item
                        :command="{ data: scope.row, type: 'generate' }"
  ...
  <script setup>
import { apiGetList, apiDeleteById } from "~/api/project/version";
...
const setValue = (value) => {
  ...
  formData.template_type = value.template_type;
  formData.output_path = value.output_path;
